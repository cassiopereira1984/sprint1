...
Crea el mètode throw que no fa altra cosa que tirar el dau, és a dir, genera un valor aleatori per a l'objecte 
a què se li aplica el mètode.
...
$player = new PokerDice();

$player->throw() . PHP_EOL;
$player->shapeName() . PHP_EOL;
$player->fiveThrows() . PHP_EOL;
$player->getTotalThrows();
